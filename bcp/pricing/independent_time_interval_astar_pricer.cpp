...
IndependentTimeIntervalAStarPricer::IndependentTimeIntervalAStarPricer(const Instance& instance, Problem& problem) :
    problem_(problem),
...
void IndependentTimeIntervalAStarPricer::add_waypoint(const Agent a, const NodeTime nt)
{
    ZoneScopedC(TRACY_COLOUR);
...
void IndependentTimeIntervalAStarPricer::set_constant(const Agent a, const Cost constant)
{
    ZoneScopedC(TRACY_COLOUR);
...
void IndependentTimeIntervalAStarPricer::add_nodetime_penalty_all_agents(const NodeTime nt, const Cost cost)
{
    ZoneScopedC(TRACY_COLOUR);
...
void IndependentTimeIntervalAStarPricer::add_nodetime_penalty_all_except_one_agent(const Agent a,
                                                                                   const NodeTime nt,
                                                                                   const Cost cost)
{
    ZoneScopedC(TRACY_COLOUR);
...
void IndependentTimeIntervalAStarPricer::add_nodetime_penalty_one_agent(const Agent a,
                                                                        const NodeTime nt,
                                                                        const Cost cost)
{
    ZoneScopedC(TRACY_COLOUR);
...
void IndependentTimeIntervalAStarPricer::add_edgetime_penalty_all_agents(const EdgeTime et, const Cost cost)
{
    ZoneScopedC(TRACY_COLOUR);
...
void IndependentTimeIntervalAStarPricer::add_edgetime_penalty_all_except_one_agent(const Agent a,
                                                                                   const EdgeTime et,
                                                                                   const Cost cost)
{
    ZoneScopedC(TRACY_COLOUR);
...
void IndependentTimeIntervalAStarPricer::add_edgetime_penalty_one_agent(const Agent a,
                                                                        const EdgeTime et,
                                                                        const Cost cost)
{
    ZoneScopedC(TRACY_COLOUR);
...
void IndependentTimeIntervalAStarPricer::add_end_penalty_all_agents(const Time earliest,
                                                                    const Time latest,
                                                                    const Cost cost)
{
    ZoneScopedC(TRACY_COLOUR);
...
void IndependentTimeIntervalAStarPricer::add_end_penalty_all_except_one_agent(const Agent a,
                                                                              const Time earliest,
                                                                              const Time latest,
                                                                              const Cost cost)
{
...
void IndependentTimeIntervalAStarPricer::add_end_penalty_one_agent(const Agent a,
                                                                   const Time earliest,
                                                                   const Time latest,
                                                                   const Cost cost)
{
...
// void IndependentTimeIntervalAStarPricer::add_once_off_penalty_all_agents(const NodeTime nt, const Cost cost)
// {
//     ZoneScopedC(TRACY_COLOUR);
//
//     const Agent A = infeasible_solvers_.size();
...
void IndependentTimeIntervalAStarPricer::add_once_off_penalty_all_except_one_agent(const Agent a,
                                                                                   const NodeTime nt,
                                                                                   const Cost cost)
{
    ZoneScopedC(TRACY_COLOUR);
...
template void IndependentTimeIntervalAStarPricer::add_once_off_penalty_all_except_one_agent<OnceOffDirection::LEq>(
    const Agent a, const NodeTime nt, const Cost cost);
template void IndependentTimeIntervalAStarPricer::add_once_off_penalty_all_except_one_agent<OnceOffDirection::GEq>(
    const Agent a, const NodeTime nt, const Cost cost);

template<OnceOffDirection d>
void IndependentTimeIntervalAStarPricer::add_once_off_penalty_one_agent(const Agent a,
                                                                        const NodeTime nt,
                                                                        const Cost cost)
{
    ZoneScopedC(TRACY_COLOUR);
...
template void IndependentTimeIntervalAStarPricer::add_once_off_penalty_one_agent<OnceOffDirection::LEq>(
    const Agent a, const NodeTime nt, const Cost cost);
template void IndependentTimeIntervalAStarPricer::add_once_off_penalty_one_agent<OnceOffDirection::GEq>(
    const Agent a, const NodeTime nt, const Cost cost);

void IndependentTimeIntervalAStarPricer::add_rectangle_penalty_one_agent(const Agent a,
...
Cost IndependentTimeIntervalAStarPricer::solve()
{
    ZoneScopedC(TRACY_COLOUR);
