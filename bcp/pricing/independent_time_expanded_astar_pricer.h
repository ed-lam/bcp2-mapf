...
class IndependentTimeExpandedAStarPricer : public PricerBase
{
  ...
  public:
    ...
    IndependentTimeExpandedAStarPricer& operator=(const IndependentTimeExpandedAStarPricer&) noexcept = delete;
    IndependentTimeExpandedAStarPricer& operator=(IndependentTimeExpandedAStarPricer&&) noexcept = delete;

    // Pricer type
    constexpr static auto name() { return "Independent time-expanded A*"; }
