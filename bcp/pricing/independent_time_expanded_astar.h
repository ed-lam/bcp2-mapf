...
class IndependentTimeExpandedAStar
{
    ...
    // Costs
    Cost constant_;
    EdgeTimePenalties edgetime_penalties_;
    ...
    // Debug
#ifdef CHECK_USING_TIASTAR
    IndependentTimeIntervalAStar<feasible> tiastar_;
#endif
  ...
  public:
    ...
    IndependentTimeExpandedAStar& operator=(const IndependentTimeExpandedAStar&) noexcept = delete;
    IndependentTimeExpandedAStar& operator=(IndependentTimeExpandedAStar&&) noexcept = delete;
